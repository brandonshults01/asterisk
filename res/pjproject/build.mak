export PJDIR := /home/brandon/src/asterisk/res/pjproject
...
# FFMPEG dlags
FFMPEG_CFLAGS =  -DPJMEDIA_HAS_LIBAVFORMAT=1 -DPJMEDIA_HAS_LIBAVCODEC=1 -DPJMEDIA_HAS_LIBSWSCALE=1 -DPJMEDIA_HAS_LIBAVUTIL=1  
FFMPEG_LDFLAGS =   -lavformat -lavcodec -lswscale -lavutil 
...
export APP_LDLIBS := -lpjnath-$(TARGET_NAME)\
	...
	-lpj-$(TARGET_NAME)\
	-luuid -lm -lnsl -lrt -lpthread   -lavformat -lavcodec -lswscale -lavutil  -lv4l2 -lcrypto -lssl -lopencore-amrnb
